(function() {
    ...
    describe('Add a record Via Form Tests : ', function() {
        ...
        it('Add a record via form', function() {
            var origRecordCount;
            var fieldTypeClassNames = ['allTextFields', 'allPhoneFields', 'allEmailFields', 'allUrlFields', 'allDurationFields', 'allNumericFields', 'allDateFields', 'allTimeFields', 'allCheckboxFields', 'allUserField'];
            ...
            for (var i = 0; i < fieldTypeClassNames.length; i++) {
                formsPO.enterFormValues(fieldTypeClassNames[i]);
            }

            //Step 4 - Click Save on the form
            formsPO.clickFormSaveBtn();
            //wait until report rows in table are loaded
            browser.waitForVisible('.ag-row');
