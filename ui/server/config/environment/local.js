...
(function() {
    ...
    module.exports = {
        ...
        // your host(ie:saforrian.local) to ../server/config/keys
        ...
        ip : 'saforrian.local', // replace with your host or machine name user use (that is in your hosts file i.e.'CMBL13XXXXXX' for mobile testing)

        //Java REST endpoint (protocol,server,port)
        //javaHost: 'https://saforrian.local:8443',
        javaHost: 'http://saforrian.local:8080',
        //javaHost: 'http://saforrian.local:8080',
        isMockServer : true,

        //Express Server
        //DOMAIN: 'https://saforrian.local:9443',
        DOMAIN: 'http://saforrian.local:9000',
        //DOMAIN  : 'http://saforrian.local:9000',
