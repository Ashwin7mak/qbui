...
class FeatureSwitchService extends BaseService {
    ...
    constructor() {
        ...
        this.API = {
            GET_FEATURE_SWITCHES    : `${constants.BASE_URL.CLIENT}/${constants.ADMIN}/${constants.FEATURE_SWITCHES}`,
            POST_FEATURE_SWITCH     : `${constants.BASE_URL.CLIENT}/${constants.ADMIN}/${constants.FEATURE_SWITCHES}`,
            PUT_FEATURE_SWITCH      : `${constants.BASE_URL.CLIENT}/${constants.ADMIN}/${constants.FEATURE_SWITCHES}/{0}`,
            DELETE_FEATURE_SWITCHES : `${constants.BASE_URL.CLIENT}/${constants.ADMIN}/${constants.FEATURE_SWITCHES}/bulk`,

            POST_OVERRIDE    : `${constants.BASE_URL.CLIENT}/${constants.ADMIN}/${constants.FEATURE_SWITCHES}/{0}/${constants.FEATURE_OVERRIDES}`,
            PUT_OVERRIDE     : `${constants.BASE_URL.CLIENT}/${constants.ADMIN}/${constants.FEATURE_SWITCHES}/{0}/${constants.FEATURE_OVERRIDES}/{1}`,
            DELETE_OVERRIDES : `${constants.BASE_URL.CLIENT}/${constants.ADMIN}/${constants.FEATURE_SWITCHES}/{0}/${constants.FEATURE_OVERRIDES}/bulk`,

            GET_FEATURE_STATES : `${constants.BASE_URL.CLIENT}/${constants.FEATURE_STATES}`
        };
    }
