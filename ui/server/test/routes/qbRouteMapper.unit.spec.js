...
describe('Qb Route Mapper Unit Test', function() {
    ...
    function corePathModificationProvider() {
        ...
        return [
            ...
            {message: 'GET request to health via tomcat all', request: '/api/api/v1/health', expectedPath: '/api/api/v1/health', route: routeConsts.TOMCAT_ALL, method: routeMapper.fetchAllFunctionForRoute(routeConsts.TOMCAT_ALL), expectedDefined: true, httpVerb: 'GET'},
            ...
            {message: 'GET request to Node/Express health check endpoint', request: '/api/v1/health', expectedPath: '/api/v1/health', route: routeConsts.HEALTH_CHECK, method: routeMapper.fetchGetFunctionForRoute(routeConsts.HEALTH_CHECK), expectedDefined: true, httpVerb: 'GET'},
