...
describe('Qb Route Mapper Unit Test', function() {
    ...
    function nodePathProvider(routeMapper, publicRoutesOnly) {
        ...
        return [
            ...
            {message: 'GET request to Node health check endpoint', request: '/qbn/health', expectedPath: '/qbn/health', route: routes.QBUI_HEALTH, method: routeMapper.fetchGetFunctionForRoute(routes.QBUI_HEALTH), expectedDefined: expectedDefined, httpVerb: 'GET'}
        ];
    }
