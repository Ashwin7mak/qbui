...
describe('Group Route Mapper Unit Test', function() {
    ...
    function routeIsEnabledForGroupProvider() {
        return [
            ...
            {message: 'LH_V1, '+ routeConsts.TICKET + ' GET', routeGroup: routeGroups.LH_V1, route: routeConsts.TICKET, method: 'get', expectedOutput: false},
            {message: 'LH_V1, '+ routeConsts.REALM + ' GET', routeGroup: routeGroups.LH_V1, route: routeConsts.REALM, method: 'get', expectedOutput: false},
            ...
            {message: 'LH_V1, '+ routeConsts.TICKET + ' POST', routeGroup: routeGroups.LH_V1, route: routeConsts.TICKET, method: 'post', expectedOutput: false},
            {message: 'LH_V1, '+ routeConsts.REALM + ' POST', routeGroup: routeGroups.LH_V1, route: routeConsts.REALM, method: 'post', expectedOutput: false},
            ...
            {message: 'LH_V1, '+ routeConsts.TICKET + ' DELETE', routeGroup: routeGroups.LH_V1, route: routeConsts.TICKET, method: 'delete', expectedOutput: false},
            {message: 'LH_V1, '+ routeConsts.REALM + ' DELETE', routeGroup: routeGroups.LH_V1, route: routeConsts.REALM, method: 'delete', expectedOutput: false},
            ...
            {message: 'LH_V1, '+ routeConsts.TICKET + ' PATCH', routeGroup: routeGroups.LH_V1, route: routeConsts.TICKET, method: 'patch', expectedOutput: false},
            {message: 'LH_V1, '+ routeConsts.REALM + ' PATCH', routeGroup: routeGroups.LH_V1, route: routeConsts.REALM, method: 'patch', expectedOutput: false},
            ...
            {message: 'LH_V1, '+ routeConsts.TICKET + ' PUT', routeGroup: routeGroups.LH_V1, route: routeConsts.TICKET, method: 'put', expectedOutput: false},
            {message: 'LH_V1, '+ routeConsts.REALM + ' PUT', routeGroup: routeGroups.LH_V1, route: routeConsts.REALM, method: 'put', expectedOutput: false},
            ...
            {message: 'DEBUG, '+ routeConsts.TICKET + ' GET', routeGroup: routeGroups.DEBUG, route: routeConsts.TICKET, method: 'get', expectedOutput: true},
            {message: 'DEBUG, '+ routeConsts.REALM + ' GET', routeGroup: routeGroups.DEBUG, route: routeConsts.REALM, method: 'get', expectedOutput: true},
            ...
            {message: 'DEBUG, '+ routeConsts.TICKET + ' POST', routeGroup: routeGroups.DEBUG, route: routeConsts.TICKET, method: 'post', expectedOutput: false},
            {message: 'DEBUG, '+ routeConsts.REALM + ' POST', routeGroup: routeGroups.DEBUG, route: routeConsts.REALM, method: 'post', expectedOutput: true},
            ...
            {message: 'DEBUG, '+ routeConsts.TICKET + ' DELETE', routeGroup: routeGroups.DEBUG, route: routeConsts.TICKET, method: 'delete', expectedOutput: false},
            {message: 'DEBUG, '+ routeConsts.REALM + ' DELETE', routeGroup: routeGroups.DEBUG, route: routeConsts.REALM, method: 'delete', expectedOutput: true},
            ...
            {message: 'DEBUG, '+ routeConsts.TICKET + ' PATCH', routeGroup: routeGroups.DEBUG, route: routeConsts.TICKET, method: 'patch', expectedOutput: false},
            {message: 'DEBUG, '+ routeConsts.REALM + ' PATCH', routeGroup: routeGroups.DEBUG, route: routeConsts.REALM, method: 'patch', expectedOutput: true},
            ...
            {message: 'DEBUG, '+ routeConsts.TICKET + ' PUT', routeGroup: routeGroups.DEBUG, route: routeConsts.TICKET, method: 'put', expectedOutput: false},
            {message: 'DEBUG, '+ routeConsts.REALM + ' PUT', routeGroup: routeGroups.DEBUG, route: routeConsts.REALM, method: 'put', expectedOutput: true},
