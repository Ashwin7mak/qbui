...
// import {legacyHTTPClient} from 'legacyHTTPClient';
// let legacyHTTPClient = requireCommon('/governance/services/legacyHTTPClient');
...
describe('Governance - base state setup', function() {
    ...
    beforeAll(() => {
        ...
        return legacyHTTPClient.postRequest(path, "post", null, "", 2).then(function(httpResponse) {
