...
import {editRecordCancel, editRecordCommit, saveRecord} from '../actions/recordActions';
...
let history = AppHistory.setup(fluxxor, store, editRecordCancel, editRecordCommit, saveRecord).history;
