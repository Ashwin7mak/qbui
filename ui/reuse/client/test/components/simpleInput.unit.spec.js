...
describe('SimpleInput', () => {
    ...
    it('will render a SimpleInput component', () => {
        ...
        const simpleInput = component.find(".simpleInput");
    ...
    it('will render a passed in className for simpleInput', () => {
        ...
        const simpleInput = component.find(".simpleInput .mockSimpleInputClassName");
    ...
    it('will render an isInvalid className if there is a validationErrorMessage', () => {
        ...
        const isInvalid = component.find(".simpleInput .isInvalid");
    ...
    describe('input', () => {
        ...
        it('will render a passed in className for input', () => {
            ...
            const input = component.find(".input .mockClassNameInput");
    ...
    describe('label', () => {
        ...
        it('will render a passed in className for label', () => {
            ...
            const label = component.find(".label .mockClassNameLabel");
