        ...
        describe('Report Faceting Tests on ' + testcase.breakpointSize + " breakpoint", function() {
            ...
            beforeAll(function(done) {
                ...
                e2eBase.reportsBasicSetUp().then(function(appAndRecords) {
                    //resize the browser taking values from dataprovider
            ...
            if (testcase.breakpointSize !== 'small') { //There wont be any facet tokens in the container for small breakpoint
