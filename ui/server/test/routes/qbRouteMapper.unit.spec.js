...
describe('Qb Route Mapper Unit Test', function() {
    ...
    function nodePathProvider() {
        return [
            {message: 'GET request to resolve facets', request: '/qbn/facets/parse', expectedPath: '/qbn/facets/parse', route: routes.FACET_EXPRESSION_PARSE, method: routeMapper.fetchGetFunctionForRoute(routes.FACET_EXPRESSION_PARSE), expectedDefined: true, httpVerb: 'GET'},
