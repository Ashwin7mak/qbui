    ...
    */
    it('Should create and retrieve dateTime display records when no format flags set', function (done) {
        ...
        recordBase.createApp(appWithNoFlags).then(function (appResponse) {
            ...
            console.log("DATETIME APP: " + JSON.stringify(app));
            var dateTimeField;
            ...
            console.log("DATETIME FIELD: " + JSON.stringify(dateTimeField));
                    ...
                    for (var i = 0; i < results.length; i++) {
                        ...
                        currentRecord.forEach(function (fieldValue) {
                            if (fieldValue.id === records[i].expectedFieldValue.id) {
                                console.log('EXPECTED DATETIME: ' +JSON.stringify(records[i].expectedFieldValue));
                                console.log('ACTUAL DATETIME: ' +JSON.stringify(fieldValue));
