...
describe('Qb Route Mapper Unit Test', function() {
    ...
    function corePathModificationProvider() {
        ...
        return [
            ...
            {message: 'GET request to reqUserAdmin endpoint', request: '/api/l/v1/ticket/reqUserAdmin', expectedPath: '/api/api/l/v1/ticket/reqUserAdmin', route: routeConsts.IS_REQ_USER_ADMIN, method: routeMapper.fetchGetFunctionForRoute(routeConsts.IS_REQ_USER_ADMIN), expectedDefined: true, httpVerb: 'GET'},
