...
function TracingProvider(tracingConfig) {
    return {
        ...
        initTracingMiddleware() {
            ...
            const tracingHost = require('./utility/configUtils').parseStringConfigValue(tracingConfig.tracingHost);

            try {
                asyncDns.resolve4Async(tracingHost).then(function(addresses) {
