...
describe('Qb Route Mapper Unit Test', function() {
    ...
    function corePathModificationProvider() {
        ...
        return [
            {message: 'GET request to record endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/records/1', expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/records/1', route: routes.RECORD, method: routeMapper.fetchGetFunctionForRoute(routes.RECORD), expectedDefined: true, httpVerb: 'GET'},
            {message: 'GET request to records endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/records', expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/records', route: routes.RECORDS, method: routeMapper.fetchGetFunctionForRoute(routes.RECORDS), expectedDefined: true, httpVerb: 'GET'},
            ...
            {message: 'GET request to paged report record endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/records/1' + testPagingQueryParams, expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/records/1' + testPagingQueryParams, route: routes.RECORD, method: routeMapper.fetchGetFunctionForRoute(routes.RECORD), expectedDefined: true, httpVerb: 'GET'},
            {message: 'GET request to table homepage id endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/homepage', expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/homepage', route: routes.TABLE_HOMEPAGE_REPORT, method: routeMapper.fetchGetFunctionForRoute(routes.TABLE_HOMEPAGE_REPORT), expectedDefined: true, httpVerb: 'GET'},
            ...
            {message: 'GET request to form and record components endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/records/fakeRecord/formComponents', expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/records/fakeRecord/formComponents', route: routes.FORM_AND_RECORD_COMPONENTS, method: routeMapper.fetchGetFunctionForRoute(routes.FORM_AND_RECORD_COMPONENTS), expectedDefined: true, httpVerb: 'GET'},
            {message: 'GET request to report metadata endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/reports/2', expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/reports/2', route: routes.REPORT_META, method: routeMapper.fetchGetFunctionForRoute(routes.REPORT_META), expectedDefined: true, httpVerb: 'GET'},
            ...
            {message: 'GET request to report invoke endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/reports/2/invoke', expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/reports/2/invoke', route: routes.REPORT_INVOKE_RESULTS, method: routeMapper.fetchGetFunctionForRoute(routes.REPORT_INVOKE_RESULTS), expectedDefined: true, httpVerb: 'GET'},
            ...
            {message: 'GET request to apps endpoint', request: '/qbui/apps/fakeApp', expectedPath: '/api/api/v1/apps/fakeApp', route: routes.APPS, method: routeMapper.fetchGetFunctionForRoute(routes.APPS), expectedDefined: true, httpVerb: 'GET'},
            {message: 'GET request to app roles endpoint', request: '/qbui/apps/fakeApp/roles', expectedPath: '/api/api/v1/apps/fakeApp/roles', route: routes.APP_ROLES, method: routeMapper.fetchGetFunctionForRoute(routes.APP_ROLES), expectedDefined: true, httpVerb: 'GET'},
            {message: 'GET request to getReqUser endpoint', request: '/qbui/users/reqUser', expectedPath: '/api/api/v1/users/reqUser', route: routes.REQ_USER, method: routeMapper.fetchGetFunctionForRoute(routes.REQ_USER), expectedDefined: true, httpVerb: 'GET'},
            ...
            {message: 'POST request to record endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/records', expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/records', route: routes.RECORD, method: routeMapper.fetchPostFunctionForRoute(routes.RECORD), expectedDefined: false, httpVerb: 'POST'},
            ...
            {message: 'DELETE request to record endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/records/1', expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/records/1', route: routes.RECORD, method: routeMapper.fetchDeleteFunctionForRoute(routes.RECORD), expectedDefined: true, httpVerb: 'DELETE'},
            ...
            {message: 'DELETE request to records bulk endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/records/bulk', expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/records/bulk', route: routes.RECORDS_BULK, method: routeMapper.fetchDeleteFunctionForRoute(routes.RECORDS_BULK), expectedDefined: true, httpVerb: 'DELETE'},
            ...
            {message: 'PATCH request to record endpoint', request: '/qbui/apps/fakeApp/tables/fakeTable/records/1', expectedPath: '/api/api/v1/apps/fakeApp/tables/fakeTable/records/1', route: routes.RECORD, method: routeMapper.fetchPatchFunctionForRoute(routes.RECORD), expectedDefined: true, httpVerb: 'PATCH'},
            ...
            //
            {message: 'GET request to app users endpoint', request: '/qbui/apps/fakeApp/users', expectedPath: '/api/api/v1/apps/fakeApp/users', route: routes.APP_USERS, method: routeMapper.fetchGetFunctionForRoute(routes.APP_USERS), expectedDefined: true, httpVerb: 'GET'},
            ...
            {message: 'PUT request to app users endpoint', request: '/qbui/apps/fakeApp/users', expectedPath: '/api/api/v1/apps/fakeApp/users', route: routes.APP_USERS, method: routeMapper.fetchPutFunctionForRoute(routes.APP_USERS), expectedDefined: false, httpVerb: 'PUT'},
            ...
            {message: 'DELETE request to app users endpoint', request: '/qbui/apps/fakeApp/users', expectedPath: '/api/api/v1/apps/fakeApp/users', route: routes.APP_USERS, method: routeMapper.fetchDeleteFunctionForRoute(routes.APP_USERS), expectedDefined: false, httpVerb: 'DELETE'},
            //
            {message: 'POST request to table components endpoint', request: '/qbui/apps/1/tables/tableComponents', expectedPath: '/api/api/v1/apps/1/tables/tableComponents', route: routes.TABLE_COMPONENTS, method: routeMapper.fetchPostFunctionForRoute(routes.TABLE_COMPONENTS), expectedDefined: true, httpVerb: 'POST'},
            {message: 'PATCH request to tables endpoint', request: '/qbui/apps/1/tables/2', expectedPath: '/api/api/v1/apps/1/tables/2', route: routes.TABLE, method: routeMapper.fetchPatchFunctionForRoute(routes.TABLE), expectedDefined: true, httpVerb: 'PATCH'},
            {message: 'GET request to the health check endpoint', request: '/qbui/health', expectedPath: '/api/api/v1/health', route: routes.HEALTH_CHECK, method: routeMapper.fetchGetFunctionForRoute(routes.HEALTH_CHECK), expectedDefined: true, httpVerb: 'GET'}
        ];
    }
    ...
    function featureSwitchesPathModificationProvider() {
        return [
            {message: 'GET request to the feature states endpoint', request: '/qbui/featureStates', expectedPath: '/api/api/v1/featureStates', route: routes.FEATURE_STATES, method: routeMapper.fetchGetFunctionForRoute(routes.FEATURE_STATES), expectedDefined: true, httpVerb: 'GET'},

            {message: 'GET request to the feature switches endpoint', request: '/qbui/admin/featureSwitches', expectedPath: '/api/api/v1/admin/featureSwitches', route: routes.FEATURE_SWITCHES, method: routeMapper.fetchGetFunctionForRoute(routes.FEATURE_SWITCHES), expectedDefined: true, httpVerb: 'GET'},
            {message: 'POST request to feature switches endpoint', request: '/qbui/admin/featureSwitches', expectedPath: '/api/api/v1/admin/featureSwitches', route: routes.FEATURE_SWITCHES, method: routeMapper.fetchPostFunctionForRoute(routes.FEATURE_SWITCHES), expectedDefined: true, httpVerb: 'POST'},
            {message: 'PUT request to feature switches endpoint', request: '/qbui/admin/featureSwitches/1', expectedPath: '/api/api/v1/admin/featureSwitches/1', route: routes.FEATURE_SWITCH, method: routeMapper.fetchPutFunctionForRoute(routes.FEATURE_SWITCH), expectedDefined: true, httpVerb: 'PUT'},
            {message: 'POST request to feature switches bulk endpoint', request: '/qbui/admin/featureSwitches/bulk', expectedPath: '/api/api/v1/admin/featureSwitches/bulk', route: routes.FEATURE_SWITCHES_BULK, method: routeMapper.fetchPostFunctionForRoute(routes.FEATURE_SWITCHES_BULK), expectedDefined: true, httpVerb: 'POST'},

            {message: 'POST request to feature overrides endpoint', request: '/qbui/admin/featureSwitches/1/overrides', expectedPath: '/api/api/v1/admin/featureSwitches/1/overrides', route: routes.FEATURE_OVERRIDES, method: routeMapper.fetchPostFunctionForRoute(routes.FEATURE_OVERRIDES), expectedDefined: true, httpVerb: 'POST'},
            {message: 'PUT request to feature overrides endpoint', request: '/qbui/admin/featureSwitches/1/overrides/1', expectedPath: '/api/api/v1/admin/featureSwitches/1/overrides/1', route: routes.FEATURE_OVERRIDE, method: routeMapper.fetchPutFunctionForRoute(routes.FEATURE_OVERRIDE), expectedDefined: true, httpVerb: 'PUT'},
            {message: 'POST request to feature overrides bulk endpoint', request: '/qbui/admin/featureSwitches/1/overrides/bulk', expectedPath: '/api/api/v1/admin/featureSwitches/1/overrides/bulk', route: routes.FEATURE_OVERRIDES_BULK, method: routeMapper.fetchPostFunctionForRoute(routes.FEATURE_OVERRIDES_BULK), expectedDefined: true, httpVerb: 'POST'}
        ];
    }
