...
(function() {
    ...
    function allowedDurationType() {
        ...
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.MS)] = 1;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.MSECS)] = 1;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.MILLISECOND)] = 1;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.MILLISECONDS)] = 1;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.S)] = DURATION_CONSTS.MILLIS_PER_SECOND;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.SECS)] = DURATION_CONSTS.MILLIS_PER_SECOND;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.SECONDS)] = DURATION_CONSTS.MILLIS_PER_SECOND;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.SECOND)] = DURATION_CONSTS.MILLIS_PER_SECOND;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.M)] = DURATION_CONSTS.MILLIS_PER_MIN;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.MINUTE)] = DURATION_CONSTS.MILLIS_PER_MIN;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.MINUTES)] = DURATION_CONSTS.MILLIS_PER_MIN;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.H)] = DURATION_CONSTS.MILLIS_PER_HOUR;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.HOUR)] = DURATION_CONSTS.MILLIS_PER_HOUR;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.HOURS)] = DURATION_CONSTS.MILLIS_PER_HOUR;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.D)] = DURATION_CONSTS.MILLIS_PER_DAY;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.DAY)] = DURATION_CONSTS.MILLIS_PER_DAY;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.DAYS)] = DURATION_CONSTS.MILLIS_PER_DAY;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.W)] = DURATION_CONSTS.MILLIS_PER_WEEK;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.WEEK)] = DURATION_CONSTS.MILLIS_PER_WEEK;
        ALLOWED_DURATION_TYPE[Locale.getMessage(DURATION_CONSTS.ACCEPTED_TYPE.ACCEPTED_DURATION_TYPE + DURATION_CONSTS.ACCEPTED_TYPE.WEEKS)] = DURATION_CONSTS.MILLIS_PER_WEEK;
