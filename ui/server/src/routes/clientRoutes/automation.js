...
module.exports = (app, appConfig, baseProps) => {
    ...
    return {
        addRoutes() {
             ...
             */
            const automationBundleFileName = baseClientRoute.generateBundleFilePath('automation');
            const options = {title: 'QuickBase Automation', bundleFileName: automationBundleFileName};
