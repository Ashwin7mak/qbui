ag-Grid-Enterprise Software License Agreement
Version 1.0

THIS DOCUMENT IS A LEGAL AGREEMENT (the “Agreement”) BETWEEN AG GRID LTD. (“We,” “Us”) AND YOU OR THE ORGANIZATION ON 
WHOSE BEHALF YOU ARE ENTERING INTO THIS AGREEMENT (“You”) IN RELATION TO AG-GRID-ENTERPRISE SOFTWARE GENERALLY MADE 
AVAILABLE IN SOURCE CODE FORMAT AND/OR AG-GRID-ENTERPRISE SOFTWARE GENERALLY MADE AVAILABLE IN OBJECT CODE FORMAT. 
(The ag-Grid-Enterprise is sometimes hereinafter referred to as the “Software”.)
...
IF YOU DO NOT AGREE WITH ANY OF THE TERMS OR CONDITIONS OF THIS LICENSE AGREEMENT, DO NOT PROCEED WITH THE DOWNLOADING,
COPYING, INSTALLATION OR ANY OTHER USE OF THE SOFTWARE OR ANY PORTION THEREOF AS YOU HAVE NO RIGHTS TO DO SO. 
THE SOFTWARE IS PROTECTED BY UNITED KINGDOM COPYRIGHT LAWS AND INTERNATIONAL COPYRIGHT LAWS, AS WELL AS OTHER 
...
different functionality than the Software, and (ii) must not allow any third party to use the ag-Grid-Enterprise, 
or any portion thereof, for software development or application development purposes.
...
“Modification” means: a) any addition to or deletion from the contents of a file included in the original 
...
YOU ACKNOWLEDGE THAT TRIAL AND/OR BETA SOFTWARE MIGHT PLACE WATERMARKS ON OUTPUT, CONTAIN LIMITED FUNCTIONALITY, 
...
This Agreement is the complete and exclusive statement of the mutual understanding of the parties and supersedes and 
