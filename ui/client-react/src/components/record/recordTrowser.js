    ...
    getTrowserRightIcons() {
        ...
        return (
            <div className="saveButtons">
                ...
                {showNext &&
                    <Button className="alternativeButton" bsStyle="primary" onClick={this.saveAndNextClicked}><I18nMessage message="nav.saveAndNext"/></Button>
                }
                {this.props.recId === null &&
                <Button className="alternativeButton" bsStyle="primary" onClick={() => {this.saveClicked(true);}}><I18nMessage message="nav.saveAndAddAnother"/></Button>
                }
                <Button className="mainButton" bsStyle="primary" onClick={() => {this.saveClicked(false);}}><I18nMessage message="nav.save"/></Button>
            </div>);
    },
