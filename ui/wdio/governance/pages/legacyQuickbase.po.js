...
class legacyQuickbase {
    ...
    get buttonCommunityAsk() {
        //* Ask button on Community frame
        return browser.element('.btn-primary');
    }
    ...
    get linkManageAllUsersInAcctAdmin() {
        ...
        // return browser.element('.SideBarLink[id="manageUsersSidebar"] a[id="manageAllUsersLink"]');
    ...
    waitForPageToFullyLoad() {
        this.buttonCommunityAsk.waitForVisible();
        return this;
    }
    ...
    dismissQBUniversityPopup() {
        if (this.buttonQBUniversityDone.isVisible()) {
