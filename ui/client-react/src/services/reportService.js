...
class ReportService extends BaseService {
    ...
    constructor() {
        ...
        this.API = {
            GET_REPORT_META             : `${constants.BASE_URL.CLIENT}/${constants.APPS}/{0}/${constants.TABLES}/{1}/${constants.REPORTS}/{2}`,
            GET_REPORT_RECORDS_COUNT    : `${constants.BASE_URL.CLIENT}/${constants.APPS}/{0}/${constants.TABLES}/{1}/${constants.REPORTS}/{2}/${constants.RECORDSCOUNT}`,
            GET_REPORTS                 : `${constants.BASE_URL.PROXY}/${constants.APPS}/{0}/${constants.TABLES}/{1}/${constants.REPORTS}`,
            GET_REPORT_RESULTS          : `${constants.BASE_URL.CLIENT}/${constants.APPS}/{0}/${constants.TABLES}/{1}/${constants.REPORTS}/{2}/${constants.RESULTS}`,
            GET_INVOKE_RESULTS          : `${constants.BASE_URL.CLIENT}/${constants.APPS}/{0}/${constants.TABLES}/{1}/${constants.REPORTS}/{2}/${constants.INVOKE}`,
