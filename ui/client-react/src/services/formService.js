...
class FormService extends BaseService {
    ...
    constructor() {
        ...
        this.API = {
            ...
            GET_FORM_COMPONENTS  : `${constants.BASE_URL.CLIENT}/${constants.APPS}/{0}/${constants.TABLES}/{1}/${constants.RECORDS}/{2}/${constants.FORMCOMPONENTS}`,
            GET_FORM_COMPONENTS_ONLY  : `${constants.BASE_URL.CLIENT}/${constants.APPS}/{0}/${constants.TABLES}/{1}/${constants.FORMCOMPONENTS}`
        };
    }
