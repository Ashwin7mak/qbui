...
/**
 * The bundle loader class that is specific to the automation Functional Area.
            ...
            if (!Locale.isSupported(newLocale)) {
                ...
                try {
                    ...
                    case 'en-us':
                            ...
                            // However, automation imports client-react code for the grid that needs these strings.
                        ...
                        newAppBundle = _.merge(
                                ...
                                require('./bundles/automation-en_us')
                            );
                        break;
                    case 'fr-fr':
                            // BAD BAD BAD - we should not be importing the client-react strings!
                        ...
                        newAppBundle = _.merge(
                                ...
                                require('./bundles/automation-fr_fr')
                            );
                        break;
                    case 'de-de':
                            // BAD BAD BAD - we should not be importing the client-react strings!
                        ...
                        newAppBundle = _.merge(
                                ...
                                require('./bundles/automation-de_de')
                            );
                        break;
                    }
                } catch (e) {
...
export default AutomationBundleLoader;
