    ...
    componentDidMount() {
        ...
        if (this.props.params.appId) {
            ...
            if (this.props.params.tblId) {
                ...
                this.props.dispatch(ReportActions.loadReports(CONTEXT.REPORT.NAV, this.props.params.appId, this.props.params.tblId));
            } else {
    ...
    componentWillReceiveProps(props) {
        ...
        if (props.params.tblId) {
            if (this.props.params.tblId !== props.params.tblId) {
                ...
                this.props.dispatch(ReportActions.loadReports(CONTEXT.REPORT.NAV, props.params.appId, props.params.tblId));
            }
        } else {
            this.props.flux.actions.selectTableId(null);
        }
