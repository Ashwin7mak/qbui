(function() {
    ...
    describe('Report Sorting Via Column Header Tests  - ', function() {
        ...
        sortingTestCases().forEach(function(testcase) {
            xit(testcase.message + ' for report with FIDS, SORTLISTS and NO FACETS defined', function() {
        ...
        xit("Verify Text asc sort then by CheckBox Desc sort for report with FIDS, SORTLISTS and FACETS defined", function(done) {
            var Fids = [6, 15];
            var facetFids = [6, 15];
        ...
        xit("Verify Sorting and Checkmark beside selected Item in column header for report WITHOUT SORTFIDS or FACETS", function(done) {
        ...
        xit("Verify Checkmark appears beside sorting menuItem for report with sortFids already set.", function(done) {
            var sortList = [
                {
                    "fieldId": 11,
                    "sortOrder": "desc",
