...
// There are many Object.assign which allow us to take the default values from wdioSauce.old.conf.js and only override specific values.
...
var overrides = {
    ...
    specs: [
        ...
        baseTestDir + '/forms/formBuilder/non-pairs-part-2.e2e.spec.js',
    ],
    // Patterns to exclude.
    exclude: [
