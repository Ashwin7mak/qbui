...
const ReportRoute = React.createClass({
    ...
    loadReportFromParams(params) {
        ...
        let offset = this.props.reportData && NumberUtils.isInt(this.props.reportData.pageOffset) ? this.props.reportData.pageOffset : constants.PAGE.OFFSET;
        let numRows = this.props.reportData && NumberUtils.isInt(this.props.reportData.numRows) ? this.props.reportData.numRows : constants.PAGE.DEFAULT_NUM_ROWS;
