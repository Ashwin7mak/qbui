...
export const SET_SWITCH_DEFAULT_STATE = 'SET_SWITCH_DEFAULT_STATE';
...
export const EDIT_EXCEPTIONS = 'EDIT_EXCEPTIONS';
export const SET_EXCEPTION_STATE = 'SET_EXCEPTION_STATE';
export const EDIT_EXCEPTION_ROW = 'EDIT_EXCEPTION_ROW';
export const CONFIRM_EXCEPTION_EDIT = 'CONFIRM_EXCEPTION_EDIT';
