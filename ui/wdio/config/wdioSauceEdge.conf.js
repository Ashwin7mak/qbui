    ...
    capabilities: [
        {
            ...
            build           : 'WebdriverIO Jenkins Try Build #' + process.env.BUILD_NUMBER + ' - Windows 10 Edge Browser',
            tags            : [process.env.SAUCE_JOB_NAME + '_Win10_Edge', 'try', 'Win10', 'Edge', process.env.BUILD_NUMBER],
