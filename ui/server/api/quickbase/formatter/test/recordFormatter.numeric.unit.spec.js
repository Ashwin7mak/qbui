...
describe('Numeric record formatter unit test', function () {
    ...
    function provider() {
        ...
        var defaultRecordInput =  [[{
            "id": 7,
            "value": numberNoSeparator}]];
        var defaultRecordExp = [[{
                "id": 7,
                "value": numberNoSeparator,
                "display": numberNoSeparator}]];
        ...
        var cases =[
            { message: "Numeric - decimal only with no format", records: recordInputDecimalOnly, fieldInfo: defaultFieldInfo, expectedRecords: expectedDecimalOnly_NoFlags },
