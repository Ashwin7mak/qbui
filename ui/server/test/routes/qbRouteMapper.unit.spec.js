...
describe('Qb Route Mapper Unit Test', function() {
    ...
    function featureSwitchesPathModificationProvider() {
        return [
            ...
            {message: 'DELETE request to feature switches endpoint', request: '/api/v1/admin/featureSwitches/bulk?ids=a,b', expectedPath: '/api/v1/admin/featureSwitches/bulk?ids=a,b', route: routeConsts.FEATURE_SWITCHES_BULK, method: routeMapper.fetchDeleteFunctionForRoute(routeConsts.FEATURE_SWITCHES_BULK), expectedDefined: true, httpVerb: 'DELETE'},
            ...
            {message: 'DELETE request to feature overrides endpoint', request: '/api/v1/admin/featureSwitches/1/overrides/bulk?ids=a,b', expectedPath: '/api/v1/admin/featureSwitches/1/overrides/bulk?ids=a,b', route: routeConsts.FEATURE_OVERRIDES_BULK, method: routeMapper.fetchDeleteFunctionForRoute(routeConsts.FEATURE_OVERRIDES_BULK), expectedDefined: true, httpVerb: 'DELETE'},
